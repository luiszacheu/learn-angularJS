...
export class DespesaService {
  ...
  getAll(): Despesa[] {
    ...
    //   new Despesa(1, "Mercado", "glyphicon-shopping-cart", "Extra",
    //   new Date("2016-10-01T03:00:00Z"), 200.5),
    //   new Despesa(2, "Lazer",   "glyphicon-knight",   "Cinema",
    //   new Date("2016-10-20T03:00:00Z"), 59.9)
    // ];
    // return despesas;
  ...
  getDb(): void {
    ...
    if (this.localStorageService.get("despesas") != null){
      ...
      for (let jsonObject of jsonObjectArray){
        this.despesas.push(new Despesa(jsonObject.id, jsonObject.tipo,
        jsonObject.icone, jsonObject.nome, new Date(jsonObject.data),
        jsonObject.valor));
      }
    }
